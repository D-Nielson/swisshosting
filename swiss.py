...
def example():
    ...
    players = [
        # Example List
        {'id': 'team1',  'points': 1, 'opponents':  ['team3'] },
        {'id': 'team2',  'points': 1, 'opponents':  ['team4'] },
        {'id': 'team3', 'points': 0, 'opponents':  ['team1'] },
        {'id': 'team4', 'points':  0, 'opponents': ['team4']},
